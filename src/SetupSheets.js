...
// 스펙 4장 B의 알려진 라우팅 규칙 — 상세분류명은 마스터 연결 후 실제 값으로 교체 필요
var SEED_RULES = [
  ['FGC9361000', '42381110', '포함', 'Kakao테크포임팩트수업', '(마스터 상세분류명으로 교체)'],
  ['FGC9361000', '42381110', '포함', '아텍', '(마스터 상세분류명으로 교체)'],
  ['FGC9361000', '42381110', '포함', 'ArtWithImpact', '(마스터 상세분류명으로 교체)'],
